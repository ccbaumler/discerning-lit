...
readability_df <- data.frame(
  ...
  Score_Range = c("0-100", "0-12+", "Varies", "5-20+", "1-14+", "1-14+"),
  Interpretation = c(
...
Accessibility  - equability (allow engagement!) - communication - speed of analysis

Identify target audience for writing, Edit writing for target audience (paper, poster, blog, or lesson!), list the most readable documents for scientific sub-domains (ESL, newly entered, very busy), Publish easier in better jounrals (https://link.springer.com/article/10.1007/S11192-019-03332-4)
...
| My supp. on PCR  | 50.89895   | 11.16918           | 14.49945  | 13.38459  | 10.84939 | 10.39321                |
---
